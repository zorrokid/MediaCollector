 ...
 * @property conditionClassificationId The ID of the collection classification of the collection item.
 * @property conditionClassificationName The name of the collection classification of the collection item. Collection classification name is stored in this kind of denormalized manner to avoid having to do a join when querying for collection items.
 */
